	...
	while (g_game_patch_thread_running)
	{
		...
		for (auto p : dbg::getProcesses())
		{
			...
			if ((startsWith(app->titleId().c_str(), "CUSA")) && text_base && !found_app)
			{
				...
				// eboot.bin games
				if (startsWith(p.name().c_str(), "eboot.bin") && startsWith(p.path().c_str(), "/app0/eboot.bin"))
				{
				...
				// big2
				if (startsWith(p.name().c_str(), "big2-ps4_Shipping.elf") && startsWith(p.path().c_str(), "/app0/big2-ps4_Shipping.elf") && text_base && !found_app)
				{
				...
				// big3
				else if (startsWith(p.name().c_str(), "big3-ps4_Shipping.elf") && startsWith(p.path().c_str(), "/app0/big3-ps4_Shipping.elf") && text_base && !found_app)
				{
					if (startsWith(app->titleId().c_str(), "CUSA02320"))
					{
						SuspendApp(app_pid);
			...
			else if ((startsWith(app->titleId().c_str(), "PPSA")) && text_base && !found_app)
			{
				...
				// tll big4r
				else if (startsWith(p.name().c_str(), "tllr-boot.bin") && startsWith(p.path().c_str(), "/app0/tllr-boot.bin") && text_base && !found_app)
				{
					if ((startsWith(app->titleId().c_str(), "PPSA05684") ||
						 startsWith(app->titleId().c_str(), "PPSA05389") ||
						 startsWith(app->titleId().c_str(), "PPSA05686") ||
