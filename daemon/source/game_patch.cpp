...
void DoPatch_t2ps4(pid_t app_pid, uint64_t text_base, uint32_t idx)
{
	...
	case 0x109:
	{
		...
		write_string(app_pid, NO_ASLR(0x02a0afbb), "4889158e509f00");
		write_string(app_pid, NO_ASLR(0x02a0afc2), "4c890d8f509f00");
		write_string(app_pid, NO_ASLR(0x02a0afc9), "4c8d0d80010000");
		write_string(app_pid, NO_ASLR(0x02a0afd0), "488d1d51509f00");
		write_string(app_pid, NO_ASLR(0x02a0afd7), "b800eea388");
		write_string(app_pid, NO_ASLR(0x02a0afdc), "39c1");
		write_string(app_pid, NO_ASLR(0x02a0afde), "0f8488000000");
		write_string(app_pid, NO_ASLR(0x02a0afe4), "b8210de0b2");
		write_string(app_pid, NO_ASLR(0x02a0afe9), "39c1");
		write_string(app_pid, NO_ASLR(0x02a0afeb), "0f8490000000");
		write_string(app_pid, NO_ASLR(0x02a0aff1), "b88c0a3298");
		write_string(app_pid, NO_ASLR(0x02a0aff6), "39c1");
		write_string(app_pid, NO_ASLR(0x02a0aff8), "0f8498000000");
		write_string(app_pid, NO_ASLR(0x02a0affe), "b8dd229b6a");
		write_string(app_pid, NO_ASLR(0x02a0b003), "39c1");
		write_string(app_pid, NO_ASLR(0x02a0b005), "0f84a0000000");
		write_string(app_pid, NO_ASLR(0x02a0b00b), "b8c60cdf31");
		write_string(app_pid, NO_ASLR(0x02a0b010), "39c1");
		write_string(app_pid, NO_ASLR(0x02a0b012), "0f84a8000000");
		write_string(app_pid, NO_ASLR(0x02a0b018), "b8d9951c4a");
		write_string(app_pid, NO_ASLR(0x02a0b01d), "39c1");
		write_string(app_pid, NO_ASLR(0x02a0b01f), "0f84b0000000");
		write_string(app_pid, NO_ASLR(0x02a0b025), "b80a656f99");
		write_string(app_pid, NO_ASLR(0x02a0b02a), "39c1");
		write_string(app_pid, NO_ASLR(0x02a0b02c), "0f84b8000000");
		write_string(app_pid, NO_ASLR(0x02a0b032), "90");
		write_string(app_pid, NO_ASLR(0x02a0b033), "b8a20ff751");
		write_string(app_pid, NO_ASLR(0x02a0b038), "39c1");
		write_string(app_pid, NO_ASLR(0x02a0b03a), "0f84bf000000");
		write_string(app_pid, NO_ASLR(0x02a0b040), "b875f44c8e");
		write_string(app_pid, NO_ASLR(0x02a0b045), "39c1");
		write_string(app_pid, NO_ASLR(0x02a0b047), "0f84c7000000");
		write_string(app_pid, NO_ASLR(0x02a0b04d), "b8e2683441");
		write_string(app_pid, NO_ASLR(0x02a0b052), "39c1");
		write_string(app_pid, NO_ASLR(0x02a0b054), "0f84cf000000");
		write_string(app_pid, NO_ASLR(0x02a0b05a), "b8cdcb0831");
		write_string(app_pid, NO_ASLR(0x02a0b05f), "39c1");
		write_string(app_pid, NO_ASLR(0x02a0b061), "0f84d7000000");
		write_string(app_pid, NO_ASLR(0x02a0b067), "e9e4000000");
		write_string(app_pid, NO_ASLR(0x02a0b06c), "41b428");
		write_string(app_pid, NO_ASLR(0x02a0b06f), "488d152e120000");
		write_string(app_pid, NO_ASLR(0x02a0b076), "c6031f");
		write_string(app_pid, NO_ASLR(0x02a0b079), "e8ed000000");
		write_string(app_pid, NO_ASLR(0x02a0b07e), "41ffe1");
		write_string(app_pid, NO_ASLR(0x02a0b081), "41b428");
		write_string(app_pid, NO_ASLR(0x02a0b084), "488d15b9010000");
		write_string(app_pid, NO_ASLR(0x02a0b08b), "c60320");
		write_string(app_pid, NO_ASLR(0x02a0b08e), "e8d8000000");
		write_string(app_pid, NO_ASLR(0x02a0b093), "41ffe1");
		write_string(app_pid, NO_ASLR(0x02a0b096), "41b428");
		write_string(app_pid, NO_ASLR(0x02a0b099), "488d1584060000");
		write_string(app_pid, NO_ASLR(0x02a0b0a0), "c60321");
		write_string(app_pid, NO_ASLR(0x02a0b0a3), "e8c3000000");
		write_string(app_pid, NO_ASLR(0x02a0b0a8), "41ffe1");
		write_string(app_pid, NO_ASLR(0x02a0b0ab), "41b428");
		write_string(app_pid, NO_ASLR(0x02a0b0ae), "488d15df070000");
		write_string(app_pid, NO_ASLR(0x02a0b0b5), "c60322");
		write_string(app_pid, NO_ASLR(0x02a0b0b8), "e8ae000000");
		write_string(app_pid, NO_ASLR(0x02a0b0bd), "41ffe1");
		write_string(app_pid, NO_ASLR(0x02a0b0c0), "41b428");
		write_string(app_pid, NO_ASLR(0x02a0b0c3), "488d151a090000");
		write_string(app_pid, NO_ASLR(0x02a0b0ca), "c60323");
		write_string(app_pid, NO_ASLR(0x02a0b0cd), "e899000000");
		write_string(app_pid, NO_ASLR(0x02a0b0d2), "41ffe1");
		write_string(app_pid, NO_ASLR(0x02a0b0d5), "41b428");
		write_string(app_pid, NO_ASLR(0x02a0b0d8), "488d15050c0000");
		write_string(app_pid, NO_ASLR(0x02a0b0df), "c60324");
		write_string(app_pid, NO_ASLR(0x02a0b0e2), "e884000000");
		write_string(app_pid, NO_ASLR(0x02a0b0e7), "41ffe1");
		write_string(app_pid, NO_ASLR(0x02a0b0ea), "41b428");
		write_string(app_pid, NO_ASLR(0x02a0b0ed), "488d15900d0000");
		write_string(app_pid, NO_ASLR(0x02a0b0f4), "c60325");
		write_string(app_pid, NO_ASLR(0x02a0b0f7), "e86f000000");
		write_string(app_pid, NO_ASLR(0x02a0b0fc), "41ffe1");
		write_string(app_pid, NO_ASLR(0x02a0b0ff), "41b428");
		write_string(app_pid, NO_ASLR(0x02a0b102), "488d154b0e0000");
		write_string(app_pid, NO_ASLR(0x02a0b109), "c60326");
		write_string(app_pid, NO_ASLR(0x02a0b10c), "e85a000000");
		write_string(app_pid, NO_ASLR(0x02a0b111), "41ffe1");
		write_string(app_pid, NO_ASLR(0x02a0b114), "41b428");
		write_string(app_pid, NO_ASLR(0x02a0b117), "488d15360f0000");
		write_string(app_pid, NO_ASLR(0x02a0b11e), "c60327");
		write_string(app_pid, NO_ASLR(0x02a0b121), "e845000000");
		write_string(app_pid, NO_ASLR(0x02a0b126), "41ffe1");
		write_string(app_pid, NO_ASLR(0x02a0b129), "41b428");
		write_string(app_pid, NO_ASLR(0x02a0b12c), "488d15f10f0000");
		write_string(app_pid, NO_ASLR(0x02a0b133), "c60328");
		write_string(app_pid, NO_ASLR(0x02a0b136), "e830000000");
		write_string(app_pid, NO_ASLR(0x02a0b13b), "41ffe1");
		write_string(app_pid, NO_ASLR(0x02a0b13e), "41b428");
		write_string(app_pid, NO_ASLR(0x02a0b141), "488d15dc100000");
		write_string(app_pid, NO_ASLR(0x02a0b148), "c60329");
		write_string(app_pid, NO_ASLR(0x02a0b14b), "e81b000000");
		write_string(app_pid, NO_ASLR(0x02a0b150), "e826000000");
		write_string(app_pid, NO_ASLR(0x02a0b155), "488b1dd44e9f00");
		write_string(app_pid, NO_ASLR(0x02a0b15c), "488b15ed4e9f00");
		write_string(app_pid, NO_ASLR(0x02a0b163), "4c8b0dee4e9f00");
		write_string(app_pid, NO_ASLR(0x02a0b16a), "c3");
		write_string(app_pid, NO_ASLR(0x02a0b16b), "48c7435800000000");
		write_string(app_pid, NO_ASLR(0x02a0b173), "48895350");
		write_string(app_pid, NO_ASLR(0x02a0b177), "c3");
		write_string(app_pid, NO_ASLR(0x02a0b17b), "48893dee4e9f00");
		write_string(app_pid, NO_ASLR(0x02a0b182), "488b5350");
		write_string(app_pid, NO_ASLR(0x02a0b186), "4883435828");
		write_string(app_pid, NO_ASLR(0x02a0b18b), "48035358");
		write_string(app_pid, NO_ASLR(0x02a0b18f), "803a30");
		write_string(app_pid, NO_ASLR(0x02a0b192), "7410");
		write_string(app_pid, NO_ASLR(0x02a0b194), "807f2f01");
		write_string(app_pid, NO_ASLR(0x02a0b198), "7412");
		write_string(app_pid, NO_ASLR(0x02a0b19a), "48895730");
		write_string(app_pid, NO_ASLR(0x02a0b19e), "c6472f01");
		write_string(app_pid, NO_ASLR(0x02a0b1a2), "eb08");
		write_string(app_pid, NO_ASLR(0x02a0b1a4), "48c7435800000000");
		write_string(app_pid, NO_ASLR(0x02a0b1ac), "48893dbd4e9f00");
		write_string(app_pid, NO_ASLR(0x02a0b1b3), "41b401");
		write_string(app_pid, NO_ASLR(0x02a0b1b6), "83fe05");
		write_string(app_pid, NO_ASLR(0x02a0b1b9), "c3");
		...
		write_string(app_pid, NO_ASLR(0x026c492a), "c5fa10152667d700");
		write_string(app_pid, NO_ASLR(0x00a6dad3), "488d3c2580014003");
		write_string(app_pid, NO_ASLR(0x00a79897), "e904db1802");
		write_string(app_pid, NO_ASLR(0x02c073a0), "e84bd5abff");
		write_string(app_pid, NO_ASLR(0x02c073a5), "e814000000");
		write_string(app_pid, NO_ASLR(0x02c073aa), "e8b3000000");
		write_string(app_pid, NO_ASLR(0x02c073af), "e8fd000000");
		write_string(app_pid, NO_ASLR(0x02c073b4), "e834010000");
		write_string(app_pid, NO_ASLR(0x02c073b9), "e9de24e7fd");
		write_string(app_pid, NO_ASLR(0x02c073be), "803d23c6db0000");
		write_string(app_pid, NO_ASLR(0x02c073c5), "0f8496000000");
		write_string(app_pid, NO_ASLR(0x02c073cb), "55");
		write_string(app_pid, NO_ASLR(0x02c073cc), "4889e5");
		write_string(app_pid, NO_ASLR(0x02c073cf), "50");
		write_string(app_pid, NO_ASLR(0x02c073d0), "488d05a98c7f00");
		write_string(app_pid, NO_ASLR(0x02c073d7), "c5fa104004");
		write_string(app_pid, NO_ASLR(0x02c073dc), "c5fa1008");
		write_string(app_pid, NO_ASLR(0x02c073e0), "c5fa10500c");
		write_string(app_pid, NO_ASLR(0x02c073e5), "c5fa105824");
		write_string(app_pid, NO_ASLR(0x02c073ea), "0fb6481f");
		write_string(app_pid, NO_ASLR(0x02c073ee), "be28010000");
		write_string(app_pid, NO_ASLR(0x02c073f3), "488d3dc68c7f00");
		write_string(app_pid, NO_ASLR(0x02c073fa), "488d150143ffff");
		write_string(app_pid, NO_ASLR(0x02c07401), "c5fa5ac0");
		write_string(app_pid, NO_ASLR(0x02c07405), "c5f25ac9");
		write_string(app_pid, NO_ASLR(0x02c07409), "c5ea5ad2");
		write_string(app_pid, NO_ASLR(0x02c0740d), "c5e25adb");
		write_string(app_pid, NO_ASLR(0x02c07411), "58");
		write_string(app_pid, NO_ASLR(0x02c07412), "e8b93efbff");
		write_string(app_pid, NO_ASLR(0x02c07417), "c5fa1015393c8300");
		write_string(app_pid, NO_ASLR(0x02c0741f), "c5fa1005e5b31b00");
		write_string(app_pid, NO_ASLR(0x02c07427), "c5fa100de1b31b00");
		write_string(app_pid, NO_ASLR(0x02c0742f), "488d154d04fdff");
		write_string(app_pid, NO_ASLR(0x02c07436), "488d0d838c7f00");
		write_string(app_pid, NO_ASLR(0x02c0743d), "beffffffff");
		write_string(app_pid, NO_ASLR(0x02c07442), "b004");
		write_string(app_pid, NO_ASLR(0x02c07444), "c5f828da");
		write_string(app_pid, NO_ASLR(0x02c07448), "e8c3c777ff");
		write_string(app_pid, NO_ASLR(0x02c0744d), "488d3d6c8c7f00");
		write_string(app_pid, NO_ASLR(0x02c07454), "ba28010000");
		write_string(app_pid, NO_ASLR(0x02c07459), "31f6");
		write_string(app_pid, NO_ASLR(0x02c0745b), "e8a062fbff");
		write_string(app_pid, NO_ASLR(0x02c07460), "5d");
		write_string(app_pid, NO_ASLR(0x02c07461), "c3");
		write_string(app_pid, NO_ASLR(0x02c07462), "55");
		write_string(app_pid, NO_ASLR(0x02c07463), "4889e5");
		write_string(app_pid, NO_ASLR(0x02c07466), "c5fa1015ea3b8300");
		write_string(app_pid, NO_ASLR(0x02c0746e), "c5fa100596b31b00");
		write_string(app_pid, NO_ASLR(0x02c07476), "c5fa100d92b31b00");
		write_string(app_pid, NO_ASLR(0x02c0747e), "488d1566682900");
		write_string(app_pid, NO_ASLR(0x02c07485), "488d0d2e0b5c01");
		write_string(app_pid, NO_ASLR(0x02c0748c), "beffffffff");
		write_string(app_pid, NO_ASLR(0x02c07491), "b004");
		write_string(app_pid, NO_ASLR(0x02c07493), "c5f828da");
		write_string(app_pid, NO_ASLR(0x02c07497), "e874c777ff");
		write_string(app_pid, NO_ASLR(0x02c0749c), "488d3d170b5c01");
		write_string(app_pid, NO_ASLR(0x02c074a3), "ba00100000");
		write_string(app_pid, NO_ASLR(0x02c074a8), "31f6");
		write_string(app_pid, NO_ASLR(0x02c074aa), "e85162fbff");
		write_string(app_pid, NO_ASLR(0x02c074af), "5d");
		write_string(app_pid, NO_ASLR(0x02c074b0), "c3");
		write_string(app_pid, NO_ASLR(0x02c074b1), "55");
		write_string(app_pid, NO_ASLR(0x02c074b2), "4889e5");
		write_string(app_pid, NO_ASLR(0x02c074b5), "c5fa101557b31b00");
		write_string(app_pid, NO_ASLR(0x02c074bd), "c5fa100547b31b00");
		write_string(app_pid, NO_ASLR(0x02c074c5), "c5fa100d43b31b00");
		write_string(app_pid, NO_ASLR(0x02c074cd), "488d15c8feffff");
		write_string(app_pid, NO_ASLR(0x02c074d4), "488d0dbd8c7f00");
		write_string(app_pid, NO_ASLR(0x02c074db), "bee0e0e0c0");
		write_string(app_pid, NO_ASLR(0x02c074e0), "b004");
		write_string(app_pid, NO_ASLR(0x02c074e2), "c5f828da");
		write_string(app_pid, NO_ASLR(0x02c074e6), "e825c777ff");
		write_string(app_pid, NO_ASLR(0x02c074eb), "5d");
